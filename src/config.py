...
PROCESSING_TIME = {
    MEASUREMENT_REPORT: 0.3 * CPU_SCALE,
    HANDOVER_REQUEST: 0.2 * CPU_SCALE,
    HANDOVER_ACKNOWLEDGE: 0.2 * CPU_SCALE,
    RRC_RECONFIGURATION_COMPLETE: 0.2 * CPU_SCALE,
    PATH_SHIFT_REQUEST: 0.2 * CPU_SCALE,
    RETRANSMISSION: 0.3 * CPU_SCALE,
}
