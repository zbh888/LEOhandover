...
PROCESSING_TIME = {
    ...
    PROCESS_GROUP: 0.4 * CPU_SCALE,
    GROUP_AGGREGATION: 0.1, # This should be very fast
    GROUP_HANDOVER_MEASUREMENT: 0.2 * CPU_SCALE, # Seems not used
    GROUP_RETRANSMISSION: 0.2 * CPU_SCALE, # Seems not used
    GROUP_HANDOVER_REQUEST: 0.2 * CPU_SCALE,
    GROUP_HANDOVER_ACKNOWLEDGE: 0.2 * CPU_SCALE,
}
