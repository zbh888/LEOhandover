...
VERTICAL_DISTANCE = 1.5*SATELLITE_R
POS_SATELLITES = {
    1: (-SATELLITE_R, 0),
...
PROCESSING_TIME = {
    MEASUREMENT_REPORT: 0.1 * CPU_SCALE,
    HANDOVER_REQUEST: 0.1 * CPU_SCALE,
    ...
    GROUP_HANDOVER_MEASUREMENT: 0.1 * CPU_SCALE,
    GROUP_RETRANSMISSION: 0.1 * CPU_SCALE,
